    ...
    while (True):
        ...
        try:
            ...
            for cw_event in response["events"]:
                ...
                elif "INFO : COMMIT : COMPLETE : Auto-commit job successful. Firewall license - VM-FLEX" in cw_event["message"]:
                    licensed_auto_commit = True
                    log("Licensed Auto-Commit: " + cw_event["message"])
                elif "INFO : PANORAMA : UP : Connected to Panorama IP" in cw_event["message"] or \
                    ("INFO : COMMIT : COMPLETE : Auto-commit job successful" in cw_event["message"] and license_complete and licensed_auto_commit):
                    log("Connected to Panorama: " + cw_event["message"])
